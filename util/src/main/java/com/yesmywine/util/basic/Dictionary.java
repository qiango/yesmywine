...
public class Dictionary {
    ...
    public static final String REDIS_HOST = PropertiesUtil.getString("redisHost", "dictionary.properties");
    ...
    public static final String SSO_HOST = PropertiesUtil.getString("ssoHost", "dictionary.properties");

    public static final String WMS_HOST = PropertiesUtil.getString("wmsHost", "dictionary.properties");

...
//        Integer id, String name, Integer synchronous
        try {
            ...
            String channelCode = String.valueOf(ValueUtil.getFromJson(jsonData,"data","channelCode"));
            ValueUtil.verify(id,"id");
            ValueUtil.verify(synchronous,"synchronous");
            Boolean result = this.channelService.synchronous(id, name, type,channelCode,synchronous);
            if(result){

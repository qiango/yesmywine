...
public class CommonServiceImpl<T> implements CommonService<T> {
    ...
    @Override
    public Boolean synchronousGoods(Map<String, String> map, Integer channelId, Integer synchronous) {
        String url = "";
        switch (channelId){
            case 1: url = Dictionary.MALL_HOST+ "/goods/goods/synchronous";
            break;
        }
    ...
    @Override
    public Boolean synchronousGoods(T t, Integer channelId, Integer synchronous, Map<String, String> map) {

        String url = "";
        switch (channelId){
            case 1: url = Dictionary.MALL_HOST+ "/goods/goods/synchronous";
//            case 1: url = "http://88.88.88.84:8083"+ "/goods/goods/synchronous";
                break;
        }
